    ...
    $.omWidget('om.omGrid', {
        ...
        _create: function () {
            ...
            if (this.options.title) {
                this.hDiv = $('<div class="hDiv hDiv-title om-state-default"></div>').append('<div class="hDivBox"><table cellPadding="0" cellSpacing="0"></table></div>');
            }
            else { this.hDiv = $('<div class="hDiv om-state-default"></div>').append('<div class="hDivBox"><table cellPadding="0" cellSpacing="0"></table></div>'); }
        ...
        _buildTitle: function () {
            ...
            if (this.options.title) {
                $title.html("<div class='titleContent'><div class='titlediv-icon'></div>" + this.options.title + "</div>").show();
            } else {
                $title.empty().hide();
            }
        },
        ...
        _makeColsResizable: function () {
            ...
            $('th[axis^="col"] div', self.thead).omResizable({
                ...
                resize: function (ui, event) {
                    ...
                    bDiv.height(grid.height() - ($titleDiv.is(":hidden") ? 0 : $titleDiv.outerHeight(true))
                        - hDiv.outerHeight(true)
                        - (self.pDiv.is(":hidden") ? 0 : self.pDiv.outerHeight(true)));
        ...
        _create: function () {
            ...
            var options = self.options,
                ...
                uiDialogTitlebar = (self.uiDialogTitlebar = $('<div></div>'))
                    .append('<div class="om-dialog-title-icon"></div>')
                    .addClass(
                        'om-dialog-titlebar ' +
                        'om-widget-header ' +
                        'om-corner-all ' +
